...
const RegistrarBien = () => {
    ...
    const handleSubmit = async (e) =>{
        ...
        try {
          ...
          const {data} = await axios.post(`${apiKey}/api/bien/crear-bien`, formData);
          if(data){ 
            Swal.fire({
  ...
  return (
    <Layout  >  
    <h2 className='m-4 pl-4  '>Registrar Bien</h2>
    ...
    <div className="col-6">
      {/* Descripcion input */}
      <div className="form-outline">
        <label className="form-label font-weight-bold"  >Categoria</label>
        <Select 
        name='categoria'
