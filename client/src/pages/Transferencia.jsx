...
const Transferencia = () => {
  ...
  return (
    <Layout  >  
    <h2 className='m-4 pl-4  '>Detalles Transferencia</h2>
    <div className="card">
      <div className="card-body">
        <div className="container mb-5 mt-3">
          <div className="row d-flex align-items-baseline">
            <div className="col-xl-9">
              <p style={{ color: '#7e8d9f', fontSize: '20px' }}>TRANSFERENCIA    <strong>ID: #123-123</strong></p>
            </div>
          ...
          <div className="container">
            ...
            <div className="row">
              <div className="col-xl-8">
                <ul className="list-unstyled">
                  ...
                  <li className="text-muted">Departamento de Origen: </li>
                  <li className="text-muted">Departamento de Destino: </li>
                  <li className="text-muted">Por motivo de: xxxxxxxxxxxxx</li>
            ...
            <div className="row">
              <div className="col-xl-8">
                <p className="ms-3">Bienes registrados en esta Transferencia</p>
              </div>
