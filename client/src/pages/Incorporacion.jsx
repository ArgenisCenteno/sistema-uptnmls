...
const EditarBien = () => {
  ...
  return (
    <Layout  >  
    <h2 className='m-4 pl-4  '>Detalles Incorporacion</h2>
    <div className="card">
      <div className="card-body">
        <div className="container mb-5 mt-3">
          <div className="row d-flex align-items-baseline">
            <div className="col-xl-9">
              <p style={{ color: '#7e8d9f', fontSize: '20px' }}>INCORPORACIÓN    <strong>ID: #123-123</strong></p>
            </div>
          ...
          <div className="container">
            ...
            <div className="row">
              <div className="col-xl-8">
                <ul className="list-unstyled">
                  ...
                  <li className="text-muted">Proveedor: </li>
              ...
              <div className="col-xl-4">
                ...
                <ul className="list-unstyled">
                  ...
                  <li className="text-muted"><i className="fas fa-circle" style={{ color: '#84B0CA' }}></i> <span className="fw-bold">Fecha Registro: </span>Jun 23,2021</li>
                  <li className="text-muted"><i className="fas fa-circle" style={{ color: '#84B0CA' }}></i> <span className="me-1 fw-bold">Estado:</span><span className="badge bg-success text-black fw-bold">Procesada</span></li>
                </ul>
              </div>
            </div>
            ...
            <div className="row">
              <div className="col-xl-8">
                <p className="ms-3">Bienes registrados en esta Incorporación</p>
              </div>
              <div className="col-xl-3">
                <ul className="list-unstyled">
                   <li className="text-muted ms-3 mt-2"><span className="text-black me-4">Cantidad de Bienes</span>$111</li>
                </ul>
                <p className="text-black float-start"><span className="text-black me-3">Costo de Incorporación</span><span style={{ fontSize: '25px' }}>$1221</span></p>
              </div>
            </div>
            <hr />
            <div className="row">
